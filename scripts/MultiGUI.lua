...
function Blacklib:Window(gametitle)
    ...
    Shadow.Image = "http://www.roblox.com/asset/?id=11785023719"
    ...
    BlackImage.Image = "rbxassetid://11785023719"
    ...
    PlaLab.Text = "Made by Kater#0001"
    ...
    spawn(function()
        while task.wait() do
            titlefunc:Refresh("") wait(.2) titlefunc:Refresh("") wait(.2) titlefunc:Refresh("K") wait(.2) titlefunc:Refresh("Ka") wait(.2) titlefunc:Refresh("Kat") wait(.2) titlefunc:Refresh("Kate") wait(.2) titlefunc:Refresh("Kater") wait(.2) titlefunc:Refresh("Kater H") wait(.2) titlefunc:Refresh("Kater Hu") wait(.2) titlefunc:Refresh("Kater Hub") wait(.9) titlefunc:Refresh("Kater Hu") wait(.2) titlefunc:Refresh("Kater H") wait(.2) titlefunc:Refresh("Kater") wait(.2) titlefunc:Refresh("Kate") wait(.2) titlefunc:Refresh("Kat") wait(.2) titlefunc:Refresh("Ka") wait(.2) titlefunc:Refresh("K") wait(.2) titlefunc:Refresh("") wait(.2) titlefunc:Refresh("") wait(.2) wait(.3)
        end
    end)
...
local Win = Blacklib:Window("Game Not Supported!")
Blacklib:Notification("This game in not on our script list!")
